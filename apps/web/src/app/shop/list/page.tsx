...
import { Search, Plus, Minus, X, Zap, MapPin, Settings2, ChevronDown, ChevronUp } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search for a product (e.g. Tim Tam, Milk, Eggs)"
      ...
      {items.length === 0 ? (
        <div className="text-center py-12 text-gray-400">
          ...
          <p className="text-sm">Search and add products to your list</p>
        </div>
      ) : (
